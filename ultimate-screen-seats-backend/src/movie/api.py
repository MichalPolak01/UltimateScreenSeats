...
@router.get('{movie_id}', response={200: MovieSchema, 404: MessageSchema, 500: MessageSchema}, auth=helpers.auth_required)
...
def update_movie(request, payload: MovieUpdateSchema, movie_id: int):
    ...
    try:
        ...
        return 500, {"message": f"An unexpected error ocurred during updating movie with id {movie_id}."}
